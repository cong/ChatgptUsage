...
<h1 id="中文">ChatgptUsage</h1>

**基于[Codex-Status](https://github.com/libing93920/CodexStatus)进行魔改。**

[![Release](https://img.shields.io/github/v/release/cong/ChatgptUsage)](https://github.com/cong/ChatgptUsage/releases)
[![Downloads](https://img.shields.io/github/downloads/cong/ChatgptUsage/total)](https://github.com/cong/ChatgptUsage/releases)
[![License](https://img.shields.io/github/license/cong/ChatgptUsage)](LICENSE)

[下载最新版](https://github.com/cong/ChatgptUsage/releases/latest) · [使用说明](#快速开始) · [问题反馈](https://github.com/cong/ChatgptUsage/issues)
...
前往 [Releases](https://github.com/cong/ChatgptUsage/releases) 下载最新版本。

| 平台 | 文件 |
| --- | --- |
| Windows | `ChatgptUsage-{version}-setup.exe` |

> macOS / Linux 暂未提供预编译包，可从源码构建。

## 快速开始

1. 下载 `ChatgptUsage-*-setup.exe` 并安装
2. 启动后胶囊窗口自动出现在桌面右上角
...
<h1 id="english">ChatgptUsage</h1>

[![Release](https://img.shields.io/github/v/release/cong/ChatgptUsage)](https://github.com/cong/ChatgptUsage/releases)
[![Downloads](https://img.shields.io/github/downloads/cong/ChatgptUsage/total)](https://github.com/cong/ChatgptUsage/releases)
[![License](https://img.shields.io/github/license/cong/ChatgptUsage)](LICENSE)

[Download](https://github.com/cong/ChatgptUsage/releases/latest) · [Getting Started](#getting-started) · [Issues](https://github.com/cong/ChatgptUsage/issues)

### Preview

## Why ChatgptUsage?

ChatgptUsage helps you:
...
Go to [Releases](https://github.com/cong/ChatgptUsage/releases) for the latest version.
...
1. Download and install `ChatgptUsage-*-setup.exe`
